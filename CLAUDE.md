...
|---|---|---|---|
| `US-###` | Historia de usuario viva del diseño | Global, auto-incremento | **US-094** (US-081 reservada; US-082-083 = Sprint 7; US-084 = #175 plan editable manual; US-085 = #177 org libre + inactiva; US-086 = #178 stakeholders catálogo tenant; US-087 = #179 reportes KPIs; US-088 = #189 hard delete two-step; US-089 = #193 email bienvenida nuevo user; US-090 = #201 plan columns Outline/Duration/Pred/Succ; US-091 = #205 áreas/equipos/actores jerarquía; US-092 = #210 reportes historial; US-093 = #211 reportes creación IA) |
| `BUG-###` | Bug reportado por el owner | Propio, auto-incremento | **BUG-044** (BUG-032-036 = Sprint 7; BUG-037 = #171 botón Enviar UX; BUG-038 = #181 INBOX estado simultáneo; BUG-039 = #184 boolean default postgres; BUG-040 = #186 documents extensión + 1MB; BUG-041 = #191 descarga `.file` content-disposition; BUG-042 = #206 breadcrumb programa→org PMO/admin; BUG-043 = #207 panel programa PMO no clicable) |
| `ENH-###` | Enhancement sobre US existente | Propio, auto-incremento | **ENH-057** (ENH-035 = #158 post-MVP/v2.0; ENH-036-037 = Sprint 7; ENH-038-044 = Sprint 8; ENH-045 = #192 password 12→8; ENH-046 = #194 reportes dow+hora; ENH-047 = #196 plan WBS toggle; ENH-048 = #197 chips hitos/críticos/retrasados; ENH-049 = #198 columna responsable; ENH-050 = #199 hito relacionado; ENH-051 = #200 criticidad; ENH-052 = #202 botones import row; ENH-053 = #203 IA column mapping; ENH-054 = #204 RAID full editable; ENH-055 = #209 reportes layout 3 vistas + catálogo; ENH-056 = #212 reportes mensual día del mes) |
