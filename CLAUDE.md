...
|---|---|---|---|
| `US-###` | Historia de usuario viva del diseño | Global, auto-incremento | **US-051** |
| `BUG-###` | Bug reportado por el owner | Propio, auto-incremento | **BUG-006** |
| `ENH-###` | Enhancement sobre US existente | Propio, auto-incremento | **ENH-001** |
