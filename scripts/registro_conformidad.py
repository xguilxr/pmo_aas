...
CIERRES = {
 ...
 "DIS-04":("PARCIAL","2026-08-06 — frontera `lib/confirmar.ts` que exige objeto, consecuencia y reversibilidad SIN valor por defecto; distingue borrado blando de duro porque conviven los dos. Migrados los 3 avisos que no nombraban nada; quedan 21 crudos en línea base que solo encoge. La consecuencia no la escribía NINGUNO de los 24"),
