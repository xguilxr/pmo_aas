...
### Bloque 1 (1 de 1)
- [x] US-110 #329 — BYO universal (`custom` OpenAI-compatible para Together/Mistral/vLLM/etc.) + Azure OpenAI / Microsoft Copilot M365 (provider `azure` con deployment_name + api_version) — `<TBD>`
